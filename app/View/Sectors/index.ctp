...
<div class="span9">
    <div class="navbar filtrosAdm">
        ...
        <a class="btn actionMenu pull-right" style="margin-left:10px" href="<?php echo $this->Html->url('/sectors/add'); ?>">Adicionar Dispositivo</a>
        <a class="btn actionMenu pull-right" id="multidelete" href="#">Deletar Dispositivos</a>
    </div>
	<br clear="all"/>
    <div id="content">
        <?php
            $this->Grid->controllerName = 'Sector';
            $this->Grid->nome = 'sectors';
