...
<div class="span9">
	<div class="row-fluid">
		<div class="hero-unit">
			...
			<?php echo $this->Form->create('User',array('id'=>'cnsdtiAdd')); ?>
            <fieldset>
                <div class="control-group">
                    <?php echo $this->Form->input('name', array('placeholder' => "Nome", "label" => false)) ?>
                </div>
                <div class="control-group">
                    <?php echo $this->Form->input('login', array('placeholder' => "Login", "label" => false)) ?>
                </div>
                <div class="control-group">
                    <?php echo $this->Form->input('password', array('placeholder' => "Senha", "label" => false, 'type'=>'password')) ?>
                </div>
